      ...
      >
        ...
        <Grid.Col span={{ base: 12, sm: 7, md: 8, lg: 9 }}>
          ...
          <p>
            ...
            I study how humans and AI systems can collaborate to complete high-impact societal tasks more effectively. I examine the sociotechnical conditions under which language models can responsibly augment expert reasoning. My research identifies points of model failure and develops alignment mechanisms—such as abstention and expert-driven knowledge extraction—that enforce accountability to human values, particularly in sensitive, high-stakes settings. I focus on domains like homelessness services and suicide prevention, where reliable collaboration and expert oversight are essential.
          </p>
          <p>
